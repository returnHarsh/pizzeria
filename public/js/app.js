...
function _initAdmin() {
  _initAdmin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(socket) {
    var orderTableBody, orders, markup, renderItems, generateMarkup;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          renderItems = function _renderItems(items) {
            ...
            return parseItems.map(function (menuItems) {
...
addToCart.forEach(function (item) {
  item.addEventListener("click", function (e) {
    var pizza = JSON.parse(item.dataset.pizza);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizzeria"] = self["webpackChunkpizzeria"] || [];
